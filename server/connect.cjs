...
function userRoutes(app) {
  ...
  app.post("/cart/add", async (req, res) => {
    ...
    try {
      ...
      await users.updateOne({ email }, { $push: { cart: cartItem } });
  ...
  app.post("/favorites/add", async (req, res) => {
    ...
    try {
      ...
      await users.updateOne({ email }, { $push: { favorites: product } });
  ...
  app.post("/cart/remove", async (req, res) => {
    ...
    try {
      ...
      await users.updateOne({ email }, { $pull: { cart: { id: id } } });
  ...
  app.post("/favorites/remove", async (req, res) => {
    ...
    try {
      ...
      await users.updateOne({ email }, { $pull: { favorites: { id: id } } });
